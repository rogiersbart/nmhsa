...
[![CRAN status](https://www.r-pkg.org/badges/version/nmhsa.svg)](https://CRAN.R-project.org/package=nmhsa)
<!-- badges: end -->
...
Here's a minimal example with the `cement` training image provided in the
package:
